...
(3) Run `cmake <path to source directory>'
    ...
    * Add -DPLOT3D_FORMAT=extended to allow for i/o on larger grids (>50 M grid points)
(4) Running `make' will build the executables and place them in the bin directory.
