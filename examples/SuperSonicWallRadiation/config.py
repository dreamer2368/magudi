...
def grid(size,xMin,xMax,yMin,yMax):
		...
		wallHeight = wallProfile(np.linspace(0., 1., size[0]), 0.001,20)
...
if __name__ == '__main__':
		...
		initial_condition(g, u1=1.25, u2=0.0).save(outputPrefix+'.ic.q')
		target_state(g, u1=1.25, u2=0.0, S=0.05).save(outputPrefix+'.target.q')
